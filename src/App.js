...
// class App extends Component { <----- this line is for class components. Next line is for functional ones that intend to use hooks
...
// state = {
  //   persons: [
    ...
    // render() { Normally, return and all of its components would go here }
